...
uint16_t HTU21D::readValue(byte cmd) {
  ...
  this->_i2cPort->beginTransmission(HTU21D_ADDRESS);
  this->_i2cPort->write(cmd); //Measure value (prefer no hold!)
...
//Returns 1000 if not initialized
